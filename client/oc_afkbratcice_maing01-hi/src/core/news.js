...
import { useGoogleSession } from "../libs/capo-google-auth";
//@@viewOff:imports
...
const News = createVisualComponent({
  ...
  render(props) {
    const itemList = [
      {
        src: "https://drive.google.com/file/d/1IuBJ3_jO-SIIiVjLqoDwHu4bbJTVgcj8/view",
      ...
      {
        src: "https://uuapp.plus4u.net/uu-webkit-maing02/b6d739b46b0a4f4980891c3c54a6df5d/image-placeholder-02",
        children: wrapContent(
          "Stress in the city",
